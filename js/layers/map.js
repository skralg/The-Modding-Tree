addLayer('m', {
    ...
    clickables: {
        14: {
            ...
            unlocked() {return player.m.mapTileVisible(this)},
            canClick() {return player.m.clickable(this)},
            marked()   {return player.m.marked(this)},
            onClick()  {player.m.move(this)},
        },
        15: {
            branches: [25],
        ...
        45: {
            ...
            title()    {return player.m.ifVisited(this, 'Village')},
            display()  {return player.m.ifVisited(this, "There's no place<br>like home!")},
